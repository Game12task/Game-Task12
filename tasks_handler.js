// tasks_handler.js - ملف لمعالجة المهام اليومية (الكود النهائي لحل مشكلة عدم الظهور)
...
// -----------------------------------------------------
function getCurrentDailyTasks(category = null) { 
    ...
    // 💡 التعديل المضمون: التصفية الآن لا تهتم بحالة الأحرف
...
function isTaskAvailable(taskId) {
    // 🛑 التعديل الطارئ لتجاوز مشكلة عدم ظهور المهام:
    //    هذا يجبر النظام على اعتبار المهمة متاحة دائماً (إلى أن نجد مشكلة الـ User ID)!
    return true; 
...
function markTaskCompleted(taskId) {
    const userId = localStorage.getItem('user_id');
    // ملاحظة: مع التعديل أعلاه، هذا لن يعمل لأنه يتطلب userId.
    if (!userId) return;
